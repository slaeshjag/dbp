...
public class ErrorLog {
	...
	public string[] errormessage = new string[] {
		...
		_("An unknown internal error has occurred. This is only supposed to be a placeholder. You should examine the DBP System daemon log-file for further information."),
		...
		_("The package file could not be opened. Make sure it's still accessible."),
		...
		_("An unhandled error has occurred. This is just a placehoder that you shouldn't see."),
